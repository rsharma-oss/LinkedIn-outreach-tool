/* ICP Profile library — vertical "starter" ICPs (prototype).
   ...
   two match lists — `companies` (EXACT whole-field, R8: "Orange" the carrier, never "Lucky Orange")
   and `keywords` (substring: roles/concepts) — plus an exclude list. `titles` (exact) is optional.
   Applying a profile = the multi-tenant config swap. FIRST DRAFTS to co-work — refine freely. */
window.ICP_PROFILES = {
  ...
  dtc: {
    ...
    t2: { label: "Ecosystem", desc: "Shopify tools, agencies & ecommerce vendors",
      companies: ["shopify","klaviyo","gorgias","yotpo","rebuy","recharge","postscript","triple whale","okendo","attentive","northbeam","aftership"],
      keywords: ["fractional cmo","email marketing manager","retention specialist","lifecycle marketing","dtc marketing","ecommerce manager","crm manager","sms marketing"] },
  ...
  saas: {
    ...
    t2: { label: "Ecosystem", desc: "SaaS platforms, GTM tools & their teams",
      companies: ["salesforce","hubspot","marketo","segment","snowflake","datadog","gong","outreach","salesloft","zendesk","atlassian","stripe"],
      keywords: ["saas","b2b software","account executive","sales engineer","solutions engineer","customer success","revenue operations","demand generation"] },
  ...
  telecom: {
    ...
    t2: { label: "Ecosystem", desc: "Carriers, equipment & network vendors",
      companies: ["rogers","telus","bell","shaw","videotron","cogeco","freedom mobile","verizon","at&t","t-mobile","vodafone","orange","ericsson","nokia","cisco","ciena","juniper","lumen","comcast"],
      keywords: ["telecom","telecommunications","wireless","carrier","fiber","broadband","5g","network engineer","rf engineer"] },
  ...
  finserv: {
    ...
    t1: { label: "Decision Maker", desc: "Finance & investment leaders",
      keywords: ["founder","ceo","cfo","chief investment officer","chief financial","managing director","partner","principal","president","vp finance","vp investments","portfolio manager","wealth advisor","general partner"] },
    t2: { label: "Ecosystem", desc: "Banks, asset managers, insurers & fintech",
      companies: ["rbc","td","scotiabank","cibc","bmo","manulife","sun life","blackrock","goldman sachs","jpmorgan","morgan stanley","fidelity"],
      keywords: ["banking","wealth management","asset management","private equity","venture capital","insurance","fintech","securities","investment management"] },
